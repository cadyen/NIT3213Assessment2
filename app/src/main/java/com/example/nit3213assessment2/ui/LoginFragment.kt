...
class LoginFragment : Fragment(), View.OnClickListener {
    ...
    private fun checkCredentials(usernameInput:String,
    ...
    private fun loginErrorReason(usernameInput:String,
                         passwordInput:String,
                         correctUsername:String,
    ...
    override fun onClick(v: View?) {
        ...
        if (checkCredentials(usernameInput, passwordInput, usernameCorrect, passwordCorrect)) {
            ...
            val loginErrorMessage = loginErrorReason(usernameInput, passwordInput, usernameCorrect, passwordCorrect)
